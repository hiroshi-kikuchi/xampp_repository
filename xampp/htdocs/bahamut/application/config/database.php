...
$db['default']['username'] = 'hiroshi';
$db['default']['password'] = 'hiroshi';
...
$db['master']['username'] = 'hiroshi';
$db['master']['password'] = 'hiroshi';
$db['master']['database'] = 'auth';
...
$db['slave']['username'] = 'hiroshi';
$db['slave']['password'] = 'hiroshi';
$db['slave']['database'] = 'auth';
